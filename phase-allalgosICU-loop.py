...
# ---------------------------
folder_path = r"C:\Users\GOPAL\neurips dataset\ICU TEST MODIFIED"
csv_output_path = r"C:\Users\GOPAL\neurips dataset\ICU TEST\breathing_rates_results.csv"

# Initialize results list
results = []

# Loop through all files from i1.h5 to i24.h5
for file_num in range(1, 25):
    file_name = f"i{file_num}.h5"
